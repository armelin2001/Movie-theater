...
{
    //I made this class because is more safe to make the data base alterations in a separete class, so i will instantiate this class in movie controler 
    public class RepositoryMovie
    {
        ...
        public List<Movie> ListAllMovies(){
            var allMovies = database.Movies.ToList();
            return allMovies;
        }
